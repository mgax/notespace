...
cork_ui._new_note_model = function(parent_note_model, callback) {
    ...
    $.post('notes', {props: $.toJSON(props)}, function(note_id) {
        ...
        if(verbose) console.log('new note model', child_model.get_id());
...
function make_note_model(id, props, html, children) {
    return {
        set_prop: function(key, value, callback) {
            if(verbose) console.log('note', id, 'setting property', key, 'to', value);
            props[key] = value;
        ...
        add_child: function(child_model, callback) {
            ...
            if(verbose) console.log('note', id, 'appending child', child_id);
        ...
        delete: function(callback) {
            if(verbose) console.log('deleting note', id);
